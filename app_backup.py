...
if 'page' not in st.session_state:
    st.session_state.page = 'home'  # 'home', 'sig_meeting', 'peer_meeting', 'edit', 'results', or 'template'
...
def go_to_peer_meeting():
    ...
    st.session_state.meeting_type = 'Peer Conversation'
...
# MAIN UI LOGIC
st.title("Peer to Peer Learning System")
